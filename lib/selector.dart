  ...
  Widget build(BuildContext context) {
    ...
    Center(child: Column(
      children: [
        ...
        }, child: Text('ورود',style: TextStyle(fontSize: 25),),style:TextButton.styleFrom(backgroundColor: Colors.white,primary: Colors.blueAccent,elevation: 10,
        shape:RoundedRectangleBorder(borderRadius: BorderRadius.circular(15) ),fixedSize: Size(330,60)
      
    )),
     TextButton(onPressed: (){
       Navigator.of(context).push(MaterialPageRoute(builder: (context)=>SignUp()));
     }, child: Text('ثبت نام',style: TextStyle(fontSize: 25)),style:TextButton.styleFrom(backgroundColor: Colors.blueAccent,primary: Colors.white,elevation: 10,
        shape:RoundedRectangleBorder(borderRadius: BorderRadius.circular(15) ),fixedSize: Size(330,60)
